...
fetch("./products.json")
  ...
  .then((data) => {
    console.log("Datos cargados:", data); // Para verificar la estructura de los datos
    if (!data.products) {
      throw new Error('La clave "products" no existe en los datos cargados.');
    }
...
function removeFromCart(index) {
  ...
  document
    ...
    .dispatchEvent(new Event("show.bs.modal")); // Refrescar modal
}
